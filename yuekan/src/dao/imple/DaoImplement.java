...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void queryEvaluate(String evaluateURL, Goods g) {
		...
		System.out.println("-----ddddddddd-------" + getSubUtilSimple(GetPage,regex1));
		
		int i=Integer.parseInt(si);
		System.out.println(i);
		for(int n=1;n<=i;n++){
			String url=evaluateURL.substring(0, evaluateURL.length() - 1) + n;
		    ...
		    while(m.find()){
				...
				ev.setGoodsId(g.getGoodsId());
//				String data = m.group(1).substring(1, evaluateURL.length() - 1);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private void addEvaluate(Evaluate ev) {
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public Goods queryGoods(Member m, String goodsURL, String evaluateURL){
		System.out.println("userName: " + m.getUserId());
		if(this.getGoodsIdByGoodsURL(goodsURL) == null){
			...
			this.addGoogs(g);
			System.out.println("goodsId--1: "+g.getGoodsId());
			g = this.getGoodsIdByGoodsURL(goodsURL);
			
			System.out.println("goodsId--2: "+g.getGoodsId());
...
//		        	g.setGoodsAttribute(Double.parseDouble(line));
	...
	private double getGoodsAttribute(String goodsId) {
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;	
	...
	private Goods getGoods(String goodsURL) {
		Goods g = new Goods();
		...
		for(Element e : eles){
			...
			if(matcher.find()){
				...
				System.out.println("goodsName: " + g.getGoogsName());
				return g;
			}		
		}
